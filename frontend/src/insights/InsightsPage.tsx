...
type NetWorthPoint = Record<NetWorthAccountKey, number> & {
  date: string
  dateLabel: string
  tooltipLabel: string
  total: number
...
function NetWorthStackedAreaChart({
  series,
  displayCurrency,
}: {
    ...
    <div className="relative">
      ...
      <div className="space-y-4">
        ...
        <section className="app-card">
          ...
          <NetWorthStackedAreaChart series={netWorthSeries} displayCurrency={displayCurrency} />
        </section>

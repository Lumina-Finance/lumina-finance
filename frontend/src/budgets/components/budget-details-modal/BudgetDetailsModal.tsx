...
import BudgetDetailsSidebar from '@/budgets/components/budget-details-modal/BudgetDetailsSidebar'
...
import BudgetEditModal from '@/budgets/components/budget-editor-modal/BudgetEditModal'

"""Seed the currencies table with ISO 4217 data."""
...
CURRENCIES: list[tuple[str, str, str, int]] = [
    ...
    ("JOD", "Jordanian Dinar", "د.ا", 3),  # noqa: RUF001
    ("JPY", "Japanese Yen", "¥", 0),
    ("KES", "Kenyan Shilling", "KSh", 2),
    ("KGS", "Kyrgyzstani Som", "с", 2),  # noqa: RUF001
    ...
    ("TOP", "Tongan Paʻanga", "T$", 2),  # noqa: RUF001
    ("TRY", "Turkish Lira", "₺", 2),
...
async def seed_currencies() -> None:
    """Update/insert every currency in :data:`CURRENCIES` into the database."""
    rows = [
    ...
    async with async_session() as db:
        ...
        stmt = stmt.on_conflict_do_update(
            ...
            set_={
                ...
                "minor_unit_exponent": stmt.excluded.minor_unit_exponent,
            },
        )
        await db.execute(stmt)
        await db.commit()
    print(f"Seeded {len(rows)} currencies.")

...
// than hugging the facet. This caps that height
...
/**
 * Renders the desktop account filter control, a collapsing glass pill whose panel opens as an
...
export function AccountFilterPanel({
  ...
  // the panel hugging the facet. The height is capped at the viewport less a bottom margin, so a

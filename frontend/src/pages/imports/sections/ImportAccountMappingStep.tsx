    ...
    <ImportStep index="03" title="Account Mapping">
      {!accountsFailed && (
        <ImportNotice title="Currency Handling">
          Imported amounts are treated as raw values. During import, each amount will be assigned the base currency of the mapped account, or the currency shown against a new account, which starts from what the file states and is yours to change.
        </ImportNotice>
      )}
      {accountsFailed ? (
        <ImportLoadFailure

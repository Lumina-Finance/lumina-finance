...
import BudgetEditorModalCadenceSection from '@/pages/budgets/components/budget-editor-modal/BudgetEditorModalCadenceSection'
import BudgetEditorModalCategorySection from '@/pages/budgets/components/budget-editor-modal/BudgetEditorModalCategorySection'
import BudgetEditorModalFooter from '@/pages/budgets/components/budget-editor-modal/BudgetEditorModalFooter'
import BudgetEditorModalScopeSection from '@/pages/budgets/components/budget-editor-modal/BudgetEditorModalScopeSection'
import BudgetEditorModalShell, { type BudgetEditorModalShellAppearance } from '@/pages/budgets/components/budget-editor-modal/BudgetEditorModalShell'

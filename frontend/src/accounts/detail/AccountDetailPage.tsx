...
import EditAccountIdentityModal from '@/accounts/detail/components/edit-identity/EditAccountIdentityModal'
import MonthlyCashFlowCard from '@/accounts/detail/components/monthly-cash-flow/MonthlyCashFlowCard'
import { TopCategoriesBySpendingCard } from '@/accounts/detail/components/spending-breakdown/TopCategoriesBySpendingCard'

...
def run_migrations_offline() -> None:
    """Run migrations in 'offline' mode — emits SQL without connecting to the database."""
...
def run_migrations_online() -> None:
    """Entry point for online migrations — bridges async engine into Alembic's sync API."""

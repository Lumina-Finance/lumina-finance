...
import BudgetCardsSection from '@/pages/budgets/components/budget-cards/BudgetCardsSection'
import BudgetCreateModal from '@/pages/budgets/components/budget-editor-modal/BudgetCreateModal'
import BudgetDetailsModal from '@/pages/budgets/components/budget-details-modal/BudgetDetailsModal'

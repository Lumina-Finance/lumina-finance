...
export const ACCOUNT_LINK_SAVE_MIN_LOADING_MS = LOADING_ANIMATION_MIN_MS
export const LIMIT_SAVE_FEEDBACK_MS = LOADING_ANIMATION_MIN_MS
export const LIMIT_DELETE_FEEDBACK_MS = LOADING_ANIMATION_MIN_MS
export const CREATE_TAX_CATEGORY_MIN_LOADING_MS = LOADING_ANIMATION_MIN_MS
export const DELETE_TAX_CATEGORY_MIN_LOADING_MS = LOADING_ANIMATION_MIN_MS

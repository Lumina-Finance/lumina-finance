...
/**
 * Renders the mobile toolbar action row below account search
 */
export function MobileToolbarActions({ activeFilterCount, onOpenFilters, onAddAccount }: MobileToolbarActionsProps) {
  return (

...
import BudgetEditorModalCadenceSection from '@/pages/budgets/components/budget-editor-modal/sections/BudgetEditorModalCadenceSection'
import BudgetEditorModalCategorySection from '@/pages/budgets/components/budget-editor-modal/sections/BudgetEditorModalCategorySection'
import BudgetEditorModalFooter from '@/pages/budgets/components/budget-editor-modal/layout/BudgetEditorModalFooter'
import BudgetEditorModalScopeSection from '@/pages/budgets/components/budget-editor-modal/sections/BudgetEditorModalScopeSection'
import BudgetEditorModalShell, { type BudgetEditorModalShellAppearance } from '@/pages/budgets/components/budget-editor-modal/layout/BudgetEditorModalShell'

...
def _build_response(
    *,
    ...
    return FireflyTransactionImportResponse(
        ...
        accounts_reused=len(stats.reused_account_ids),
        categories_created=stats.categories_created,
        categories_reused=len(stats.reused_category_ids),
        merchants_created=stats.merchants_created,
        merchants_reused=len(stats.reused_merchant_ids),
        tags_created=stats.tags_created,
        tags_reused=len(stats.reused_tag_ids),

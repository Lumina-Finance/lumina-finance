/**
 * Renders the official Google G mark for use inside an app-styled button
 *
 * The unmodified multi-colour G sits directly on the button surface at the same footprint
